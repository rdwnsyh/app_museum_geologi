...
const Edit = () => {
    const { koleksifosil } = usePage().props || {}; // Mengambil data yang dikirim dari controller
    console.log(koleksifosil);

    const { data, setData, errors, post, put, processing, setError } = useForm({
        //halaman 1
        // id: koleksibatuan?.id || "",
        kategori_bmn: koleksifosil?.kategori_bmn || "",
        nup_bmn: koleksifosil?.nup_bmn || "",
        no_regis: koleksifosil?.no_regis || "",
        no_inventaris: koleksifosil?.no_inventaris || "",
        tipe_bmn: koleksifosil?.tipe_bmn || "",
        no_awal: koleksifosil?.no_awal || "",
        satuan: koleksifosil?.satuan || "",
        kelompok_koleksi: koleksifosil?.kelompok_koleksi || "",
        jenis_koleksi: koleksifosil?.jenis_koleksi || "",
        kode_koleksi: koleksifosil?.kode_koleksi || "",
        ruang_penyimpanan: koleksifosil?.ruang_penyimpanan || "",
        lokasi_penyimpanan: koleksifosil?.lokasi_penyimpanan || "",
        lantai: koleksifosil?.lantai || "",
        no_lajur: koleksifosil?.no_lajur || "",
        no_lemari: koleksifosil?.no_lemari || "",
        no_laci: koleksifosil?.no_laci || "",
        no_slot: koleksifosil?.no_slot || "",

        //halaman 2
        kondisi: koleksifosil?.kondisi || "",
        nama_koleksi: koleksifosil?.nama_koleksi || "",
        deskripsi_koleksi: koleksifosil?.deskripsi_koleksi || "",
        keterangan_koleksi: koleksifosil?.keterangan_koleksi || "",
        umur_geologi: koleksifosil?.umur_geologi || "",
        nama_formasi: koleksifosil?.nama_formasi || "",
        ditemukan: koleksifosil?.ditemukan || "",
        pulau: koleksifosil?.pulau || "",
        provinsi: koleksifosil?.provinsi || "",
        kota: koleksifosil?.kota || "",
        alamat: koleksifosil?.alamat || "",
        latitude: koleksifosil?.latitude || "",
        longitude: koleksifosil?.longitude || "",
        elevasi: koleksifosil?.elevasi || "",
        peta: koleksifosil?.peta || "",
        skala: koleksifosil?.skala || "",
        lembar_peta: koleksifosil?.lembar_peta || "",

        //halaman 3
        cara_peroleh: koleksifosil?.cara_peroleh || "",
        thn_peroleh: koleksifosil?.thn_peroleh || "",
        determinator: koleksifosil?.determinator || "",
        kolektor: koleksifosil?.kolektor || "",
        kepemilikan_awal: koleksifosil?.kepemilikan_awal || "",
        publikasi: koleksifosil?.publikasi || "",
        url: koleksifosil?.url || "",
        nilai_peroleh: koleksifosil?.nilai_peroleh || "",
        nilai_buku: koleksifosil?.nilai_buku || "",

        //halaman 4
        gambar_satu: koleksifosil?.gambar_satu || null,
        gambar_dua: koleksifosil?.gambar_dua || null,
        gambar_tiga: koleksifosil?.gambar_tiga || null,
        vidio: koleksifosil?.vidio || null,
        audio: koleksifosil?.audio || null,
    });
    ...
    function handleSubmit(e) {
        ...
        if (step === 4) {
            put(
                route("kelolakoleksifosil.update", koleksifosil.id),
                formData,
                {
                    onSuccess: () => {
                        // Berhasil
    ...
    return (
        <div>
            <Head title={`edit ${koleksifosil?.nama_koleksi}`} />
                            ...
                            <>
                                ...
                                >
                                    <FileInput
                                        name="gambar_satu"
                                        error={errors.gambar_satu}
                                        existingFile={koleksifosil.gambar_satu} // Menampilkan file yang sudah ada
                                        onFileChange={(file) =>
                                            handleFileChange(
                                                "gambar_satu",
                                                file
                                ...
                                >
                                    <FileInput
                                        name="gambar_dua"
                                        error={errors.gambar_dua}
                                        existingFile={koleksifosil.gambar_dua}
                                        onFileChange={(file) =>
                                ...
                                >
                                    <FileInput
                                        name="gambar_tiga"
                                        error={errors.gambar_tiga}
                                        existingFile={koleksifosil.gambar_tiga}
                                        onFileChange={(file) =>
                                            handleFileChange(
                                                "gambar_tiga",
                                                file
                                ...
                                >
                                    <FileInput
                                        name="vidio"
                                        error={errors.vidio}
                                        existingFile={koleksifosil.vidio}
                                        onFileChange={(file) =>
                                ...
                                >
                                    <FileInput
                                        name="audio"
                                        error={errors.audio}
                                        existingFile={koleksifosil.audio}
                                        onFileChange={(file) =>
