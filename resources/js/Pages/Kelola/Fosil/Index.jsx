...
function Index() {
    const { koleksifosil } = usePage().props;

    const data = koleksifosil?.data || [];
    const links = koleksifosil?.meta?.links || [];

    const handleDelete = (id) => {
        if (window.confirm("Are you sure you want to delete this item?")) {
            router.delete(route("kelolakoleksifosil.destroy", id), {
                onSuccess: () => {
            ...
            <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center justify-end mb-2">
                    <Link
                        ...
                        href={route("kelolakoleksifosil.create")}
                    >
